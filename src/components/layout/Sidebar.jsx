...
export function Sidebar() {
  ...
  return (
    <aside className="w-64 bg-white border-r border-slate-200/90 flex flex-col justify-between px-3 py-2 h-[calc(100vh-4rem)] sticky top-16 shrink-0 overflow-y-auto scrollbar-none text-left">
